...
MarketPlace release will be done only twice a year.Incase you want latest version, install the current version on the marketplace and do an upgrade right after.
